...
/*   Updated: 2022/09/23 14:44:28 by sjo              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int cut_cmd_line(t_cmd_node **curr_cmd_head, t_token_node **curr_token, char *line)
{
...
int	make_cmd_list(t_cmd_list **cmd_line_list, t_token_node *token_head, char *line)
{
	int				idx;
